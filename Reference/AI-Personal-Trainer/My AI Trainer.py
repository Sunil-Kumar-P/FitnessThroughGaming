...
while True:
    ...
    img2 = img.copy()
    if img2 is not None and img2.any():  # Check if img2 is not None and has elements
    ...
    cv2.putText(
        img, str(twister_cnt), (1360, 260), cv2.FONT_HERSHEY_DUPLEX, 3, (0, 0, 0), 5
    )
    cv2.putText(
        img, str(pushups_cnt), (1360, 480), cv2.FONT_HERSHEY_DUPLEX, 3, (0, 0, 0), 5
    )
